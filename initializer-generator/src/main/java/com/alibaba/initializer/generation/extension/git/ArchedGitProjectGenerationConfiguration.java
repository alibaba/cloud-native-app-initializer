...
package com.alibaba.initializer.generation.extension.git;
...
/**
 * set module condition on GitProjectGenerationConfiguration
 *
 * @author <a href="mailto:chenxilzx1@gmail.com">theonefx</a>
 */
@InitializerProjectGenerationConfiguration
@ConditionalOnModule(root = true)
public class ArchedGitProjectGenerationConfiguration extends GitProjectGenerationConfiguration {
